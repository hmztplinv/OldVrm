...
<div class="container-fluid bg-light pt-5 p-3 small animate__animated animate__fadeIn">
    <ol class="breadcrumb small pt-5">
        ...
        <li class="breadcrumb-item text-custom"><a href="" class="text-decoration-none text-custom">Bordro Cetveli</a></li>
    </ol>
        ...
        <div class="col-12 col-sm-12 mb-3">
            <div class="card h-100">
                <header class="card-header d-md-flex align-items-center bg-custom2">
                    <h6 class="card-header-title text-light mt-1">Bordro Cetveli</h6>
                </header>
                <div class="container-fluid" style="">
                    <div class="row ">
                        ...
                        <div class="col-12 mt-3 col-md-8 text-center" >
                            <b style="font-size: 23px; padding: 5px 0px;">BORDRO CETVELİ</b>
                        </div>
                        <div class="col-12 mt-5 col-md-2 text-md-right d-flex" STYLE="font-size: 22px">
                            <select class="form-select w-50" aria-label="Default select example" style="height: fit-content;">
        ...
        <div class="p-3" style="background-color: white">
            ...
            <table id="example" class="display excel  table-bordered" style="width:100%;font-size: 14px"  >
                ...
                <tr>
                    ...
                    <th  >Adı Soyadı</th>
                    <th  >Tc No</th>
                    <th  >Normal Çalışma Toplamı</th>
                    <th >Fazla Çalışma Toplamı</th>
                    <th>Ek Kazançlar Toplamı</th>
                    <th >Özel Kesintiler Toplamı</th>
                    <th >Sigorta Primleri Toplamı</th>
                    <th >Vergiler Toplamı</th>
                    <th >Yasal Kesintiler Toplamı</th>
                    <th >Gelir Vergisi İndirimleri Toplamı</th>
                ...
                <tr>
                    <td>
                        <form action="bordro_pdf" method="POST" target="_blank">
                            <button type="submit" class="btn btn-md btn-custom " formmethod="post">İndir</button>
                        </form>
                    </td>
                    <td> 1</td>
                    <td>Ofis</td>
