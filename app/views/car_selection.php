...
<div class="container-lg bg-light pt-5 p-3 small animate__animated animate__fadeIn">
    ...
    <div class="row">
        <div class="col-lg-2 col-md-6 col-6">
            <button type="submit" name="" id="" class="btn btn-md btn-custom w-100 mt-3">Önerilen<i class="fa-solid fa-filter"></i></button>
        </div>

        <div class="col-lg-2 col-md-6 col-6">
            <button type="submit" name="" id="" class="btn btn-md btn-custom w-100 mt-3">Fiyata Göre Artan<i class="fa-solid fa-arrow-up me-1"></i></button>
        </div>

        <div class="col-lg-2 col-md-6 col-6">
            <button type="submit" name="" id="" class="btn btn-md btn-custom w-100 mt-3">Fiyata Göre Azalan<i class="fa-solid fa-arrow-down me-1"></i></button>
        </div>

        <div class="col-lg-2 col-md-6 col-6">
            <button type="submit" name="" id="" class="btn btn-md btn-custom w-100 mt-3">Kilometre Aralığı<i class="fas fa-tachometer-alt"></i></button>
        </div>
    </div>
            ...
            <div class="card bg-white text-center  shadow-sm ">
                <div class="row">
                    ...
                    <div class="col-md-3 col-6">
                        ...
                        <p class="pt-3 text-left font-weight-bold text-dark"><i class="fa-sharp fa-solid fa-check me-1"></i>Ücretsiz İptal</p>
                        <button type="submit" name="" id="" class=" mt-4 btn btn-md btn-custom btn_selected me-1">Hemen Kirala<i class="fa-solid fa-arrow-right me-1"></i></button>
                    </div>
                </div>
            </div>
            <div class=" mt-4 card bg-white text-center  shadow-sm ">
                <div class="row">
                    <div class="col-md-6 col-12">
                        <img src="public/img/gezinomi_images/fiat-egea-sedan.png" class="img-fluid" width="400" height="500" alt="" srcset="">
                    </div>
                    ...
                    <div class="col-md-3 col-6">
                        <p class="pt-3 text-left font-weight-bold text-dark"><i class="fa-sharp fa-solid fa-money-check me-1"></i>3 Gün Toplam: 960 TL</p>
                        <p class="pt-3 text-left font-weight-bold text-dark"><i class="fa-sharp fa-solid fa-money-check me-1"></i>Günlük Fiyat: 320 TL</p>
                        <p class="pt-3 text-left font-weight-bold"><i class="fa-sharp fa-solid fa-check me-1 "></i>Ücretsiz İptal</p>
                        <button type="submit" name="" id="" class=" mt-4 btn btn-md btn-custom btn_selected">Hemen Kirala<i class="fa-solid fa-arrow-right me-1"></i></button>
                    </div>
                </div>
            </div>
            <div class=" mt-4 card bg-white text-center  shadow-sm ">
