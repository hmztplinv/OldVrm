...
<div class="container-fluid bg-light pt-5 p-3 small animate__animated animate__fadeIn">
    ...
    <ol class="breadcrumb small pt-5">
        ...
        <li class="breadcrumb-item text-custom"><a href="" class="text-decoration-none text-custom">Kart Okutmama </a></li>
    </ol>
</div>
    ...
    <div class="col-12 col-sm-12 mb-3">
        <div class="card h-100">
            <header class="card-header d-md-flex align-items-center bg-custom2">
                <h6 class="card-header-title text-light mt-1">Kart Okutmama Formu</h6>
            </header>
            <div class="row" style="margin: auto;margin-top: 15px">
                <div class="col-sm-6" style="background-color: green;color: white;font-size: 22px;width: 100px;height: 65px;text-align: center"><label style="margin-top: 15px">8</label></div>
                <div class="col-sm-6" style="text-align: center;width: 100px;height: 65px;background-color: lightgrey"><label style="  font-size: 22px;margin-top: 15px">1</label></div>
            ...
            <div class="container-fluid" style="">
                ...
                <div class="row">
                    ...
                    <div class="" style="margin: auto">
                        <table class="table table-bordered mt-4" style="width: 30%;margin:auto">
                    ...
                    <div class="row mt-2" >
                        ...
                        <div class="mt-2 col-12 col-lg-3" style=" display: inline-block;">
                            <table class="table table-bordered" style="width: 200px">
                                <thead>
                                <tr>
                    ...
                    <div class="" style="text-align: center; margin: auto;width: 70%;height: ">
                        <header class="card-header  bg-custom2">
                    ...
                    <div class="col-12 col-md-2">
                        <table class="table table-bordered" style="width: 200px">
                            <tr>
                                ...
                                <th scope="col" style="width: 50%"> 19:42</th>
                            </tr>
                        </table>
                    </div>
                    <div class="col-md-2"></div>
                ...
                <div class="row ml-5 mt-2">
                    ...
                    <div class="col-12 col-md-6">
                        <table class=" border" style="width: 30%;text-align: center">
                            <tbody>
                            <tr>
                                <td style="height: 80px"></td>
                            </tr>
                            <tr>
                                <td style="">Lütfi Gürses</td>
                            </tr>
                            <tr>
                                <td colspan="2">Yazılım</td>
                            </tr>
                ...
                <div class="mt-3" style="text-align: center; margin: auto;width: 70%;height: ">
                        <header class="card-header  bg-custom2">
                            <h6 class="card-header-title text-light mt-1">Onay</h6>
                        </header>
                </div>
                <div class="row ml-5 mt-3" style="">
                ...
                <div class="row mt-2" style="text-align: center"><span>
