...
<div class="container-fluid bg-light pt-5 p-3 small animate__animated animate__fadeIn">
    ...
    <ol class="breadcrumb small pt-5">
        ...
        <li class="breadcrumb-item text-custom"><a href="" class="text-decoration-none text-custom">Kart Okutmama Mazeret Formu</a></li>
    </ol>
    <div class="row pt-2" style="">
        <div class="col-12 col-sm-12 mb-3">
            <div class="card h-100">
                <header class="card-header d-md-flex align-items-center bg-custom2">
                    <h6 class="card-header-title text-light mt-1">Kart Okutmama Mazeret Formu</h6>
                </header>
                <div class="container-fluid" >
                    <div class="col-sm-6 mx-auto mt-4" >
                        <div class="row w-25 pr-0 float-right">
                            <div class="col-sm-6" style="background-color: green;color: white;font-size: 22px;text-align: center"><label style="margin-top: 15px">8</label></div>
                            <div class="col-sm-6" style="text-align: center;background-color: lightgrey"><label style="  font-size: 22px;margin-top: 15px">1</label></div>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        ...
                        <div class="row" >
                            <div class="col-md-12">
                                <table class="table table-bordered mt-4">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">00000197 </td>

                                    </tr>
                                    <tr>
                                        <th scope="row">Departman :</th>
                                        <td colspan="2">Temizlik Hizmetleri</td>

                                    </tr>
                                    <tr>
                                        <th scope="row">Görev :</th>
                                        <td colspan="2">Temizlik Görevlisi </td>

                                    </tr>
                                    <tr>
                                        <th scope="row">Okutmama Nedeni :</th>
                                        <td colspan="2"> </td>
                            ...
                            <div class="col-md-4">
                                <table class="table table-bordered">
                                    <tr>
                                        <th scope="col" style="width: 50%">Giriş / Çıkış</th>
                            ...
                            <div class="col-md-4">
                                <table class="table table-bordered">
                                    <tr>
                                        <th scope="col" style="width: 50%">Giriş</th>
                                        <th scope="col" style="width: 50%"> </th>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-md-4">
                                <table class="table table-bordered">
                                    <tr>
                                        <th scope="col" style="width: 50%">Çıkış</th>
                                        <th scope="col" style="width: 50%; background-color: lightcoral; padding: 0px;"> <i class="bi bi-x text-danger h2"></i></th>
                                    </tr>
                                </table>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 text-center mx-auto p-0 mt-3">
                        <header class="card-header  bg-custom2">
                            <h6 class="card-header-title text-light mt-1">SÜRE</h6>
                        </header>
                    </div>
                    <div class=" col-sm-5 col-10 text-center mx-auto mt-3">
                        <div class="row" >
                            ...
                            <div class="col-md-6">
                                <table class="table table-bordered">
                                    <tr>
                                        <th scope="col" style="width: 50%">Giriş Saati :</th>
                                        <th scope="col" style="width: 50%"> 09:42</th>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 float-left">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th scope="col" style="width: 50%">Çıkış Tarihi</th>
                                        <th scope="col" style="width: 50%">1.10.2023 </th>
                                    </tr>
                            ...
                            <div class="col-md-6 float-left">
                                <table class="table table-bordered">
                                    <tr>
                                        <th scope="col" style="width: 50%">Çıkış Saati :</th>
                                        <th scope="col" style="width: 50%"> .... / ....</th>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <div class="col-sm-5 col-10 text-center  mx-auto p-0">
                        <div class="col-sm-6 float-right mb-3">
                            <table class=" border w-100">
                                ...
                                <tr>
                                    <td class="font-weight-bold">Alime Doğan</td>
                                </tr>
                                <tr>
                                    <td colspan="2">Temizlik Görevlisi</td>
                                </tr>
                    ...
                    <div class="col-sm-6 text-center mx-auto p-0" style="clear: both;">
                        <header class="card-header  bg-custom2">
                            <h6 class="card-header-title text-light mt-1">Onay</h6>
                        </header>
                    </div>
                    <div class="col-sm-5 col-10 text-center mx-auto mt-3">
                        <div class="row">
                            <div class="col-md-6"  >
                                <table class=" border" style="width: 100%;text-align: center">
                                    ...
                                    <tr>
                                        <td colspan="2">Departman Müdürü</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="col-sm-6 mx-auto p-0 mt-3">
                    <span>
                        Gezinomi Seyahat Turizm Ticaret A.Ş. Mehmetçik Mah. 1242 Sok. No: 3B/2 Muratpaşa/ANTALYA Tel: 0 850 466 66 66 Fax: 0 242 763 85 44 www.gezinomi.com
                    </span>
                    </div>
                </div>
            </div>
