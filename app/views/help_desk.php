...
<div class="container-fluid bg-light pt-5 p-3 small animate__animated animate__fadeIn">
    ...
    <ol class="breadcrumb small pt-5">
        <li class="breadcrumb-item text-custom">Bilgi Teknolojileri</li>
        <li class="breadcrumb-item text-custom"><a href="" class="text-decoration-none text-custom">Yardım Masası</a></li>
    </ol>
    ...
    <div class="row pt-2">
        ...
        <div class="col-12 col-sm-12 mb-3">
            <form action="<?= site_url('help_desk') ?>" method="POST">
                <div class="card h-100">

                    <header class="card-header d-md-flex align-items-center bg-custom2">
                        <h6 class="card-header-title text-light mt-1">Yardım Masası</h6>
                    </header>
