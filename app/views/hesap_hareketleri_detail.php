...
<div class="container-fluid bg-light pt-5 p-3 small animate__animated animate__fadeIn">
    ...
    <ol class="breadcrumb small pt-5">
        ...
        <li class="breadcrumb-item text-custom"><a href="" class="text-decoration-none text-custom">Hesap Hareketleri Detay</a></li>
    </ol>
...
<div  class="row pt-2 animate__animated animate__fadeIn" id="welcomeDiv"  style="display:none;" class="answer_list">
    ...
    <div class="col-12 col-sm-12 mb-3">
        <div class="card h-100">
            <header class="card-header d-md-flex align-items-center bg-custom2">
                <h6 class="card-header-title text-light mt-1">Hesap Hareketleri Detay </h6>
            </header>
            <div class="card-body">
...
<script>
    ...
    function showDiv() {
        ...
        if (bankName.length !== 0 || iban.length !== 0 || currency.length !== 0 || transcode.length !== 0 || startDate != "" || endDate != "" || startAmount != "" || endAmount != "" || description != ""){
            ...
            $.post("<?= site_url('hesap_hareketleri_detail') ?>", {
                bankName: bankName,
                iban: iban,
                currency: currency,
                transcode: transcode,
...
<script>
    ...
    jQuery.fn.extend({
        ...
        UpdateSelect: function () {
            ...
            $.post("<?= site_url('hesap_bakiyeleri_detail') ?>", {
                answer: "1",
                cookies: arr
            }, function (result) {
                // alert(result)
