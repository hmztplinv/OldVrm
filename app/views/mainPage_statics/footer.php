...
<script src="<?= public_url('js/jquery.flexslider.js') ?>"></script>
<script src="<?= public_url('js/jquery.elevatezoom.js') ?>"></script>
<script src="<?= public_url('js/modernizr.js') ?>"></script>
<script src="<?= public_url('js/shCore.js') ?>"></script>
<script src="<?= public_url('js/shBrushXml.js') ?>"></script>
<script src="<?= public_url('js/shBrushJScript.js') ?>"></script>
<script src="<?= public_url('js/jquery.easing.js') ?>"></script>
<script src="<?= public_url('js/jquery.mousewheel.js') ?>"></script>
<script src="<?= public_url('js/demo.js') ?>"></script>
<script src="<?= public_url('public/js/popper.min.js') ?>"></script>
<script src="<?= public_url('public/js/main.js') ?>"></script>
<script src="<?= public_url('public/js/main2.js') ?>"></script>
<script src="<?= public_url('public/js/owl.carousel.min.js') ?>"></script>
