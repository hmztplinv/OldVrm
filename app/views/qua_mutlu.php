    ...
    <section id="get-a-quote" class="get-a-quote">
        <div class="container-fluid" data-aos="fade-up">
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-5 quote-bg" style="background-image: url(<?= mutlu_public_url('img/qua-mutlu-musteri.jpg') ?>);"></div>

                <div style="overflow-y:auto; " class="col-lg-7 php-email-form">
                    <div class="row">
                        <div style="overflow-y:auto;max-height: 95px" class="col-md-6">
                            <img style="width: 150px"  src="<?= public_url('img/qualogo.png') ?>" alt="bienlogo">
                        </div>
                        <div style="overflow-y:auto;max-height: 95px"  class="col-md-6 text-right">
                        </div>
                    </div>

                    <form action="<?= site_url('mutlu_musteri_qua') ?>"
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <select required class="custom-select d-block w-100" id="Iller" name="province" >
                                    <option value="0" selected disabled>Ürünün Kullanıldığı İl</option>
                            ...
                            <div class="col-md-6">
                                <select required class="custom-select d-block w-100" id="Ilceler" disabled="disabled" name="district" >
                            ...
                            <div id="complainttype" style="display: none" class="col-md-12">
                                <textarea required name="productdesc" class="form-control" placeholder="Şikayet Konusu ve Ek Bilgiler" id="" cols="20" rows="5"></textarea>
                            ...
                            <div id="detailCheck" class="col-md-12">
                                ...
                                <label for="detail">Detay eklemek istiyorum.</label><br>
							 <span class="sub-info text-danger" style="font-size: 12px;">* Detay eklemek şikayetinizin çözümünü hızlandıracaktır.</span>
                            </div>
                            <div class="col-md-12" id="detailform" style="display: none">
                              ...
                              <!--  <div style="margin-bottom: 15px;padding: 0" class="col-md-12">
                                ...
                                <div style="margin-bottom: 15px;padding: 0" class="col-md-12">
                                    <input class="form-control" placeholder="Renk Ton Kodu" type="text" name="productcolornumber">
                                </div>
                            ...
                            <div class="col-md-12">
                                <input style="height: 47px" id="files" class="form-control" required multiple type="file" name="upload[]">
                            ...
                            <div class="col-md-12">
                                <label class="d-none" for="bien"><a href="https://www.qua.com.tr/">Sitemizi ziyaret edebilirsiniz</label>
                            </div>
...
<script>
    $('#Iller').on('change', function() {
        ...
        $.post("<?=site_url('mutlu_musteri_qua')?>", { il: province })
            .done(function(result) {
                $('#Ilceler').prop('disabled', false);
                var roles = JSON.parse(result,false);
                if (document.getElementById("Ilceler").options.length !== 0){
                    var size = document.getElementById("Ilceler").options.length+1
                    for (var i = 1;i<=size;i++){
                        document.getElementById("Ilceler").remove(0);
                    }
                }
                var opt = document.createElement("option");
                opt.value = "Merkez";
                opt.text = "Merkez";
                document.getElementById("Ilceler").options.add(opt);
    ...
    document.getElementById("categories").onchange = function () {
        ...
        if (document.getElementById("complaint").value != "Öneri"){
            ...
            if (document.getElementById("categories").value == 1){
                $.post("<?= site_url('mutlu_musteri_qua') ?>", {
