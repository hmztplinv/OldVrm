...
<div class="container-fluid bg-light pt-5 p-3 small animate__animated animate__fadeIn">
    ...
    <div class="row">
        <div class="col-md-10 order-md-2">
            <div class="row">
                <div class="col-12 col-sm-6 col-md-6">
                    <button class="btn btn-custom btn-sm dropdown-toggle float-left"  type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">Seçili Kayıtlar</button>
                    ...
                    <button class="btn btn-custom btn-sm dropdown-toggle float-left ml-2"  type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">Dışarı Aktar</button>
                    <ul class="dropdown-menu float-right" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="#">ssdsf</a></li>
                        <li><a class="dropdown-item" href="#">sdfsf</a></li>
                        <li><a class="dropdown-item" href="#">sdeef</a></li>
                    ...
                    <button class="btn btn-custom btn-sm dropdown-toggle float-left ml-2"  type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">İçeri Aktar</button>
                    <ul class="dropdown-menu float-right" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="#">ssdsf</a></li>
                        <li><a class="dropdown-item" href="#">sdfsf</a></li>
                        <li><a class="dropdown-item" href="#">sdeef</a></li>
                    ...
                    <button class="btn btn-custom btn-sm dropdown-toggle float-left ml-2"  type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">Hesaplar</button>
                    <ul class="dropdown-menu float-right" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="#">ssdsf</a></li>
                        <li><a class="dropdown-item" href="#">sdfsf</a></li>
                        <li><a class="dropdown-item" href="#">sdeef</a></li>
        ...
        <div class="col-2 order-1 mb-4  d-sm-block ">
            <div class="card">
