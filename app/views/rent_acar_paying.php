...
<div class="container-lg bg-light pt-5 p-3 small animate__animated animate__fadeIn">
    ...
    <div class="row pt-2 p-3 mb-5">
        ...
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3 sepet">
                <li class="list-group-item d-flex justify-content-between lh-condensed text-white bg-custom2">
                    <div>
                        ...
                        <h6 class="my-0">İstanbul, İstanbul Havalimanı (IST)</h6>
                        <small><i class='fas fa-car mr-1 fa-2x' ></i>İzmir, İzmir Adnan Menderes Havalimannı (ABD)</small>
                    </div>
                </li>
                <li class="list-group-item d-flex justify-content-between lh-condensed text-custom">
                    <div>
                        <h6 class="my-0"><i class="fa-regular fa-calendar-days"></i> TESLİM ALIŞ TARİHİ</h6>
                        <small>17.02.2023 Cuma</small>
                    </div>
                    <div>
                        <h6 class="my-0"><i class="fa-regular fa-calendar-days"></i> TESLİM VERİŞ TARİHİ</h6>
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0">Maksimum Kapasite</h6>
                    </div>
                    <span>5 Kişi</span>
                </li>
            ...
            <div class="card-wrapper float-left w-100"></div>
        </div>
