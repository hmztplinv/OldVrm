...
<div class="container-fluid bg-light pt-5 p-3 small animate__animated animate__fadeIn">
    ...
    <ol class="breadcrumb small pt-5">
        ...
        <li class="breadcrumb-item text-custom"><a href="" class="text-decoration-none text-custom">Puantaj Detay</a></li>
    </ol>
    ...
    <div class="row pt-2">
        ...
        <div class="col-12 col-sm-12 mb-3">
            <div class="card h-100">
                <header class="card-header d-md-flex align-items-center bg-custom2">
                    <h6 class="card-header-title text-light mt-1">Puantaj Detayı</h6>
                </header>
            </div>
        </div>
        <div class="container mt-4  "  style="border: 3px solid #6B15B6" >
            <div class="row" style="">
                <div class="col-6 col-md-4" style="text-align: left;">
                    <img style="width: 200px;height: 150px;" src="<?= public_url('img/qualogo.png') ?>" alt="..." class=" ">
                </div>
                <div class="col-6 col-md-4 mt-4 text-custom" style="padding-top: 30px;text-align: center"> <label style="font-size: 22px">
                        <b>   Tek Sayfa Puantaj Cetveli</b>
                    </label>
                    <br>

                </div>
                <div class="col-12 col-md-4 mt-4  " style="text-align: right;"><label style="font-size: 21px; "class="text-custom">
                        <b>YASIN GURSES</b>
                    </label>
                    <br>
                    <label>TCKN :</label>
        ...
        <div class="container theme-showcase" style="text-align: center">

            <div id="holder" class="row " style=" display: flex;justify-content: center " ></div>
        </div>
    </div>
    </div>
</div>
...
<script type="text/tmpl" id="tmpl">
  ...
  if (mode === 'week') {
   ...
   <table class="calendar-table  table-responsive  table-condensed table-tight  "  >
    <thead>
      <tr>
            ...
            <tr>
              <td style="text-align: left;">
                <span class="btn-group">
                  <button class="js-cal-prev btn btn-default " style="background-color: #6B15B6 ;color:white">&lt;</button>
                  <button class="js-cal-next btn btn-default  " style="background-color: #6B15B6 ;color:white">&gt;</button>
                </span>
              ...
              <td>
                <span class="btn-group btn-group-lg">
                  {{ if (mode !== 'day') { }}
                    {{ if (mode === 'month') { }}<button class="js-cal-option btn   " style="background-color: #6B15B6;color:white" data-mode="year">{{: months[month] }}</button>{{ } }}
                    {{ if (mode ==='week') { }}
                      <button class="btn btn-link disabled">{{: shortMonths[first.getMonth()] }} {{: first.getDate() }} - {{: shortMonths[last.getMonth()] }} {{: last.getDate() }}</button>
                    {{ } }}
                    <button class="js-cal-years btn  "style="background-color: #6B15B6;color:white">{{: year}}</button>
                  {{ } else { }}
              ...
              <td style="text-align: right">
                <span class="btn-group">
                  <button class="js-cal-option btn btn-primary {{: mode==='year'? 'active':'' }}"style="background-color: #6B15B6" data-mode="year">Yıl</button>
                  <button class="js-cal-option btn btn-primary {{: mode==='month'? 'active':'' }}"style="background-color: #6B15B6" data-mode="month">Ay</button>
                  <button class="js-cal-option btn btn-primary {{: mode==='week'? 'active':'' }}"style="background-color: #6B15B6; " data-mode="week">Hafta</button>
                  <button class="js-cal-option btn btn-default {{: mode==='day'? 'active':'' }}" data-mode="day"><Gün></Gün></button>
                </span>
              </td>
            </tr>
          </table>
...
<script>var $currentPopover = null;
    ...
    (function ($) {
        ...
        ;(function (defaults, $, window, document) {
            ...
            shortMonths: ["Ocak", "Şubat", "Mart", "Nisan", "Mayıs", "Haziran", "Temmuz", "Agustos", "Eylül", "Ekim", "Kasım", "Aralık"],
            date: (new Date()),
    ...
    var data = [],
        ...
        h,
        m,
        //names = ['İşe Gelmedi', 'Long Event', 'Birthday Party', 'Repeating Event', 'Training', 'Meeting', 'Mr. Behnke', 'Date', 'Ms. Tubbs'],
        names=['x','y','z','f']
