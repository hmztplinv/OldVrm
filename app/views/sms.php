        ...
        <div class="col-lg-3 d-flex flex-column justify-content-center align-items-center bg-light mnh-100vh animate__animated animate__slideInLeft">
            ...
            <div class="col-12 ps-5 pe-5">
                ...
                <form action="<?= site_url('sms') ?>" method="POST">
                    ...
                    <div class="mt-4">
                        <input class="form-control" type="password" id="smsCode" name="smsCode" placeholder="Mail doğrulama kodu" required>
                    </div>
                ...
                <?php if (@$res['err']): ?>
                    <div class="mt-3">
                        <button type="button" class="btn btn-sm btn-custom2 animate__animated animate__backInLeft"><i class="fa fa-exclamation-circle alert-icon mr-3"></i><span>    <?= $res['err'] ?></span></button>
                    </div>
                <?php endif; ?>
...
<script>
    ...
    function countdown(timer) {
        ...
        intervalID = setInterval(function () {
            ...
            if (timer < 0) {
                //window.location.href = '<?= site_url('timeout') ?>';
            }
        }, 1000);
    }
...
<?php if ($sms_res['err']): ?>
<script>alert('<?= $sms_res['err'] ?>')</script>
<?php endif; ?>
</body>
</html>